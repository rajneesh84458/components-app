...
class Detail extends Component {
  ...
  render() {
    ...
    return (
      ...
      >
      <CustomHeader headerName ={detailName} navigation ={this.props.navigation}/>
                    <Icon
                            ...
                            style={{
                              paddingRight: 10,
                              position:'absolute',
                              left:330,top:0,right:0,bottom:0
        ...
        <ScrollView>
          ...
          >
            <Image
              ...
              // source ={{uri:'https://images.unsplash.com/photo-1582896911227-c966f6e7fb93?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=500&q=60'}}
              style={{
                flex: 1,
                width: wp('100%'),
                height: hp('80%'),
          ...
          >
            ...
            >
              ...
              >
                <Image
                  source={{uri:'https://images.unsplash.com/photo-1529626455594-4ff0802cfb7e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=400&q=60'}}
                  style={{
                    flex: 1,
                    width: null,
                    height: null,
